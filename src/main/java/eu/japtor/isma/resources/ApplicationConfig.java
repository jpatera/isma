...
//HK2 binders must be registered only as singletones (instances):
        register(new DependencyBinder());
        
//Register singletones (as instances):
        // Enable LoggingFilter (will be used globaly):
...
//Register per request components (as classes):
        register(ProjectServices.class);
        register(InjectResource.class);   // Note: @Singleton at resource has a higher priority
